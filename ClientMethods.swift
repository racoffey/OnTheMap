...
extension Client {
    ...
    */
    func authenticateWithViewController(hostViewController: UIViewController, completionHandlerForAuth: (success: Bool, errorString: String?) -> Void) {
      ...
      //  getSessionID("/session", parameters, completionHandlerForSession: <#T##(success: Bool, sessionID: String?, errorString: String?) -> Void#>)
...
//        let parameters = [TMDBClient.ParameterKeys.RequestToken: requestToken!]
        ...
        /* 2. Make the request */
        taskForPOSTMethod("/session", parameters: parameters) { (results, error) in
